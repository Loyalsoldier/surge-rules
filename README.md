...
- **直连域名列表 direct.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/direct.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/direct.txt)
- **代理域名列表 proxy.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/proxy.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/proxy.txt)
- **广告域名列表 reject.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/reject.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/reject.txt)
- **私有网络专用域名列表 private.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/private.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/private.txt)
- **Apple 在中国大陆可直连的域名列表 apple.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/apple.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/apple.txt)
- **iCloud 域名列表 icloud.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/icloud.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/icloud.txt)
- **[慎用]Google 在中国大陆可直连的域名列表 google.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/google.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/google.txt)
- **GFWList 域名列表 gfw.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/gfw.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/gfw.txt)
- **非中国大陆使用的顶级域名列表 tld-not-cn.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/tld-not-cn.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/tld-not-cn.txt)
- **Telegram 使用的 IP 地址列表 telegramcidr.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/telegramcidr.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/telegramcidr.txt)
- **中国大陆 IP 地址列表 cncidr.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/cncidr.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/cncidr.txt)
...
- **直连域名列表 direct.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/direct.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/direct.txt)
- **代理域名列表 proxy.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/proxy.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/proxy.txt)
- **广告域名列表 reject.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/reject.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/reject.txt)
- **私有网络专用域名列表 private.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/private.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/private.txt)
- **Apple 在中国大陆可直连的域名列表 apple.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/apple.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/apple.txt)
- **iCloud 域名列表 icloud.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/icloud.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/icloud.txt)
- **[慎用] Google 在中国大陆可直连的域名列表 google.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/google.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/google.txt)
- **GFWList 域名列表 gfw.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/gfw.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/gfw.txt)
- **非中国大陆使用的顶级域名列表 tld-not-cn.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/tld-not-cn.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/tld-not-cn.txt)
- **Telegram 使用的 IP 地址列表 telegramcidr.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/telegramcidr.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/telegramcidr.txt)
- **中国大陆 IP 地址列表 cncidr.txt**：
  ...
  - [https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/cncidr.txt](https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/cncidr.txt)
...
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/private.txt,DIRECT
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/reject.txt,REJECT
RULE-SET,SYSTEM,DIRECT
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/icloud.txt,DIRECT
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/apple.txt,DIRECT
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/google.txt,DIRECT
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/proxy.txt,PROXY,force-remote-dns
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/direct.txt,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/telegramcidr.txt,PROXY
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/cncidr.txt,DIRECT
RULE-SET,LAN,DIRECT
...
PROCESS-NAME,uTorrent,DIRECT
PROCESS-NAME,WebTorrent,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/private.txt,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/reject.txt,REJECT
RULE-SET,SYSTEM,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/icloud.txt,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/apple.txt,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/google.txt,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/proxy.txt,PROXY,force-remote-dns
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/direct.txt,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/telegramcidr.txt,PROXY
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/cncidr.txt,DIRECT
RULE-SET,LAN,DIRECT
FINAL,PROXY,dns-failed
```
...
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/reject.txt,REJECT
RULE-SET,SYSTEM,DIRECT
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/tld-not-cn.txt,PROXY,force-remote-dns
DOMAIN-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/gfw.txt,PROXY,force-remote-dns
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/telegramcidr.txt,PROXY
...
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/reject.txt,REJECT
RULE-SET,SYSTEM,DIRECT
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/tld-not-cn.txt,PROXY,force-remote-dns
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/gfw.txt,PROXY,force-remote-dns
RULE-SET,https://cos-public.ovinc.cn/loyalsoldier/surge-rules/ruleset/telegramcidr.txt,PROXY
FINAL,DIRECT,dns-failed
```
